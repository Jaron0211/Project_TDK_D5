...
def part72():
    ...
    blue_blobs = img.find_blobs([blue_sandbag],merge=False,margin = 3)
    green_blobs = img.find_blobs([green_sandbag],merge=False,margin = 3)
...
def part73():
    ...
    blue_blobs = img.find_blobs([blue_sandbag],merge=True,margin = 3)
    green_blobs = img.find_blobs([green_sandbag],merge=True,margin = 3)
