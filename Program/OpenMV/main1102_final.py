...
##test
sensor.set_auto_whitebal(False,(1.7,0.9,2.9))
...
##color range
red = (50, 75, 40, 80, 0, 60) #(36, 77, 30, 55, 5, 54)
blue = (45, 80, -20, 40, -80, -30)
green = (60, 95, -80, -20, 0, 50)

blue_sandbag = (15, 40, -20, 20, -60, -20)
green_sandbag = (15, 30, -50, -10, 0, 40)

black_circle = (0,20,-30,0,0,30)

red_line = ( 15, 40, 30, 60, -10, 40)

light_filter = (80, 100, -120, 127, -120, 127)

##contest version
#red = (45, 75, 40, 80, 20, 80) #(36, 77, 30, 55, 5, 54)
#blue = (60, 80, -20, 35, -60, -20)
#green = (75, 95, -80, -40, 0, 40)

#blue_sandbag = (0, 30, 0, 40, -60, -10)
#green_sandbag = (15, 35, -40, 0, 0, 40)

#black_circle = (0,20,-30,0,0,30)

#red_line = ( 20, 60, 20, 60, 0, 40)
...
def part2():
    ...
    blue_blobs = img.find_blobs([blue],merge=True,margin = 40)
    green_blobs = img.find_blobs([green],merge=True,margin = 40)

    all_line = img.find_lines(threshold = 2500, theta_margin = 10, rho_margin = 10)
    ...
    for a in red_blobs:
        ...
        if (a.area() < 3000 or a.h() < 55 or a.h() < 55):
            continue
        if(a.cy() < 40):
            continue
...
def part72():
    ...
    all_line = img.find_lines(threshold = 3000, theta_margin = 10, rho_margin = 20)
    img.draw_string(80,60,"P72",color=(0,0,0),size = 1)

    for a in green_blobs:
        if (a.area() < 2000 or a.w() < 30):
            continue
