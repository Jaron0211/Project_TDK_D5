...
void INFO_READ() {
  ...
  while (1) {
    if (radio.available()) {
      ...
      if(millis() - lcd_timer > 10){
      lcd.setCursor(0,0);
      lcd.print(RECEIVE_DATA.RC_INPUT[0]);
      lcd.print(" ");
      lcd.setCursor(5,0);
      lcd.print(RECEIVE_DATA.RC_INPUT[1]);
      lcd.print(" ");
      lcd.setCursor(10,0);
      lcd.print(RECEIVE_DATA.RC_INPUT[2]);
      lcd.print(" ");
      lcd.setCursor(15,0);
      lcd.print(RECEIVE_DATA.RC_INPUT[3]);
      lcd.print(" ");
      lcd.setCursor(0,1);
      lcd.print(RECEIVE_DATA.RC_INPUT[4]);
      lcd.print(" ");

      lcd.setCursor(0,2);
      lcd.print(RECEIVE_DATA.VOLTAGE);
      lcd.print(" ");
      lcd.setCursor(5,3);
      lcd.print(RECEIVE_DATA.OPENMV_STATUS);
      lcd.print(" ");
      lcd.setCursor(10,3);
      lcd.print(RECEIVE_DATA.MODE);
      lcd.print(" ");
      lcd.setCursor(15,3);
