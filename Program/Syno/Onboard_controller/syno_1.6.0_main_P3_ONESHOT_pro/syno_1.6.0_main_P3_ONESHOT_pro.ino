  ...
  if (L3_start) {
    ...
    if (L3_duty == B00000000) {
      ...
      if (
        ...
        or  (OPENMV_DATA[0] == 5 and (( DUTY_MIN * 60 + DUTY_SEC ) - ( L3_TIME[0] * 60 + L3_TIME[1] ) > 4)) //DETECT RED AND ALSO DUTY_TIME BIGGER THEN 4s
      ) {
        L3_TIME[0] = DUTY_MIN;
        L3_TIME[1] = DUTY_SEC;
        L3_duty = B00000001;
    ...
    //STABLE ON TANGENT LINE
      ...
      if (
        (( DUTY_MIN * 60 + DUTY_SEC ) - ( L3_TIME[0] * 60 + L3_TIME[1] ) > 2) //DETECT RED AND ALSO DUTY_TIME BIGGER THEN 4s
      ) {
        L3_TIME[0] = DUTY_MIN;
        L3_TIME[1] = DUTY_SEC;
        L3_duty = B00000011;
    ...
    //FOLLOW LINE AND FIND TANGENT POINT
      ...
      if (OPENMV_DATA[0] == 0) {
        ppm[1] = 1400;
      } else if ((OPENMV_DATA[0] != 0) and (( DUTY_MIN * 60 + DUTY_SEC ) - ( L3_TIME[0] * 60 + L3_TIME[1] ) < 1)) {
        ppm[1] = 1400;
      } else if (OPENMV_DATA[0] == 5) {
        ppm[1] = 1400;
      }
