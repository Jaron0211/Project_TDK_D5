...
void PID_CONTROLL(int INPUT_PITCH_BIAS,int INPUT_ROLL_BIAS){
  ...
  if(abs(INPUT_PITCH_BIAS)> 0){
    ...
    PITCH_INTERGRATE_ERROR = constrain(PITCH_INTERGRATE_ERROR,-100,100);
  }else{
  ...
  PITCH_DELTA_ERROR = constrain(PITCH_DELTA_ERROR,-100,100); 

  if(abs(INPUT_PITCH_BIAS) >= 0){
    pitch_revise = P * INPUT_PITCH_BIAS + I * PITCH_INTERGRATE_ERROR + D * PITCH_DELTA_ERROR;
  }else{
    pitch_revise = I * PITCH_INTERGRATE_ERROR + D * PITCH_DELTA_ERROR;
  }
  //ROLL

  if(abs(INPUT_ROLL_BIAS)> 5){
    ROLL_INTERGRATE_ERROR += INPUT_ROLL_BIAS ;
    ROLL_INTERGRATE_ERROR = constrain(ROLL_INTERGRATE_ERROR,-100,100);
  }else{
  ...
  ROLL_DELTA_ERROR = constrain(ROLL_DELTA_ERROR, -100, 100);
  
  if(abs(INPUT_ROLL_BIAS) >= 0){
    roll_revise = P * INPUT_ROLL_BIAS + I * ROLL_INTERGRATE_ERROR + D * ROLL_DELTA_ERROR;
  }else{
    roll_revise = I * ROLL_INTERGRATE_ERROR + D * ROLL_DELTA_ERROR;
  }
}
